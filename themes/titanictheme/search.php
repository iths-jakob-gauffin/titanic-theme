...
?>
    ...
    <?php 
        foreach ($wp_query->posts as $value) {
            ?>
                <a href="<?php the_permalink(); ?>"><h4><?php echo $value->post_title; ?></h4></a>        
        ...
        ?>
        <?php
        foreach ($catPosts as $harborWithCat) {
            ?>
                <a href="<?php the_permalink($harborWithCat); ?>"><h4><?php echo $harborWithCat->post_title; ?></h4></a>
            <?php
        }
        wp_reset_postdata();
    ?>
